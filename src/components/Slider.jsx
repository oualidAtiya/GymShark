    ...
    return(
        <main className="md:px-4">
            <div className="bg-[url('./slide.png')]  bg-top h-[80vh] md:h-[60vh] text-white  flex flex-col justify-end p-5 md:justify-center ">
                ...
                <p className="text-xl mb-7   md:w-[50%]  lg:text-start md:text-center md:mx-auto lg:mx-0">Time to pick up the gym kit you've been eyeing all season. Make it count.</p>
